...
public class AccountRestController {
    ...
    @GetMapping("/{id}")
    public Account getAccountWithId(@PathVariable int id) {
    ...
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteAccountWithId(@PathVariable long id) {
        Account acount = accountDao.findById(id);
        accountDao.remove(acount);
    }
}
